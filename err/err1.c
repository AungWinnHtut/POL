...
const size_t MAX{ 80 };											//Maximum expected characters input
char input[MAX];
size_t inputindex{};
	...
	do
	{
		...
		case')':
			if (numL == 0)
			{
				...
				strncpy_s(substr, index - buffindex, str + buffindex, index - buffindex - 1);
				return substr;
			}
