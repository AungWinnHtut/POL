...
namespace MySqlBackupAll
{
    public partial class Form1 : Form
    {
        ...
        string constr = "datasource=localhost;port=3306;username=root";
        ...
        void DoRestore()
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(constr))
            {
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    ...
                    {
                        //TODO cipher file decryption to make plain text (.sql) file here
                        ...
                        //TODO delete plain text .sql file
            ...
            using (MySqlConnection conn = new MySqlConnection(constr))
            {
                using (MySqlCommand cmd = new MySqlCommand())
                {
                    ...
                    foreach (DataRow dr in dt.Rows)
                    {
                        ...
                        //TODO encrypt plain text .sql file to cipher file (.cip) and delete plaintext file 
